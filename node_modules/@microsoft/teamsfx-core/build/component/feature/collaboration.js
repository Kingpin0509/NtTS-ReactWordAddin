...
let AadCollaboration = class AadCollaboration {
    constructor(m365TokenProvider) {
        this.aadAppClient = new aadAppClient_1.AadAppClient(m365TokenProvider);
    }
    async grantPermission(ctx, objectId, userObjectId) {
        try {
            ...
            return teamsfx_api_1.err(this.handleError(error, ctx));
        }
    }
    ...
    handleError(error, ctx) {
        ...
        if (axios_1.default.isAxiosError(error)) {
            ...
            if (error.response.status >= 400 && error.response.status < 500) {
                return new common_1.HttpClientError(componentNameAad, message);
            }
            else {
                return new common_1.HttpServerError(componentNameAad, message);
            }
        }
...
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.grantPermission, componentNameAad)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String, String]),
    tslib_1.__metadata("design:returntype", Promise)
], AadCollaboration.prototype, "grantPermission", null);
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.listCollaborator, componentNameAad)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], AadCollaboration.prototype, "listCollaborator", null);
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.checkPermission, componentNameAad)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String, String]),
    tslib_1.__metadata("design:returntype", Promise)
...
let TeamsCollaboration = class TeamsCollaboration {
    ...
    async listCollaborator(ctx, teamsAppId) {
        try {
            ...
            const appStudioToken = appStudioTokenRes.isOk() ? appStudioTokenRes.value : undefined;
            const userLists = await appStudioClient_1.AppStudioClient.getUserList(teamsAppId, appStudioToken);
            if (!userLists) {
    ...
    handleError(error, ctx) {
        ...
        if (error.innerError) {
            ...
            (_a = ctx.logProvider) === null || _a === void 0 ? void 0 : _a.error(message);
            const fxError = error.innerError.response.status &&
                error.innerError.response.status >= 400 &&
                error.innerError.response.status < 500
                ? new common_1.HttpClientError(componentNameTeams, message)
                : new common_1.HttpServerError(componentNameTeams, message);
            return fxError;
        }
        const message = JSON.stringify(error);
        (_b = ctx.logProvider) === null || _b === void 0 ? void 0 : _b.error(message);
...
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.grantPermission, componentNameTeams)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], TeamsCollaboration.prototype, "grantPermission", null);
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.listCollaborator, componentNameTeams)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String]),
    tslib_1.__metadata("design:returntype", Promise)
], TeamsCollaboration.prototype, "listCollaborator", null);
tslib_1.__decorate([
    lib_1.hooks([addStartAndEndTelemetry_1.addStartAndEndTelemetry(EventName.checkPermission, componentNameTeams)]),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object, String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
