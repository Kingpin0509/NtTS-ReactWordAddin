import { AzureAccountProvider, FxError, M365TokenProvider, Result, SubscriptionInfo } from "@microsoft/teamsfx-api";
...
declare class ProvisionUtils {
    ...
    ensureM365TenantMatchesV3(actions: string[], tenantId: string | undefined): Promise<Result<undefined, FxError>>;
}
