...
class BaseComponentInnerError extends Error {
    ...
    static unknownError(source, error) {
        return new BaseComponentInnerError(source, "SystemError", "UnhandledError", "error.common.UnhandledError", [source, JSON.stringify(error, Object.getOwnPropertyNames(error))]);
    }
}
