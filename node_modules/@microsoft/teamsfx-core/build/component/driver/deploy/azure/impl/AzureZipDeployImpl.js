...
class AzureZipDeployImpl extends azureDeployImpl_1.AzureDeployImpl {
    ...
    async azureDeploy(args, azureResource, azureCredential) {
        ...
        if (cost > deployConstant_1.DeployConstant.DEPLOY_OVER_TIME) {
            await ((_a = this.context.logProvider) === null || _a === void 0 ? void 0 : _a.info(localizeUtils_1.getLocalizedString("driver.deploy.notice.deployAcceleration", "https://aka.ms/teamsfx-config-run-from-package")));
        }
    }
    /**
    ...
    async packageToZip(args, context) {
        ...
        await ((_b = this.context.logProvider) === null || _b === void 0 ? void 0 : _b.debug(`zip dist folder ${this.distDirectory} to ${this.zipFilePath} complete`));
        return res;
    }
    /**
                ...
                if (axios_1.default.isAxiosError(e)) {
                    ...
                    if (((_b = (_a = e.response) === null || _a === void 0 ? void 0 : _a.status) !== null && _b !== void 0 ? _b : commonConstant_1.HttpStatusCode.OK) >= commonConstant_1.HttpStatusCode.INTERNAL_SERVER_ERROR) {
                        ...
                        if (retryCount < deployConstant_1.DeployConstant.DEPLOY_UPLOAD_RETRY_TIMES) {
                            await logger.warning(`Upload zip file failed with response status code: ${(_d = (_c = e.response) === null || _c === void 0 ? void 0 : _c.status) !== null && _d !== void 0 ? _d : "NA"}. Retrying...`);
                        }
                        else {
                            // if retry times exceed, throw error
                            await logger.warning(`Retry times exceeded. Upload zip file failed with remote server error. Message: ${JSON.stringify((_e = e.response) === null || _e === void 0 ? void 0 : _e.data)}`);
                        ...
                        await logger.error(`Upload zip file failed with response status code: ${(_k = (_j = e.response) === null || _j === void 0 ? void 0 : _j.status) !== null && _k !== void 0 ? _k : "NA"}, message: ${JSON.stringify((_l = e.response) === null || _l === void 0 ? void 0 : _l.data)}`);
