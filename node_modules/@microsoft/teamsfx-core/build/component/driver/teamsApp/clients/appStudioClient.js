...
(function (AppStudioClient) {
    ...
    function wrapException(e, apiName, telemetryProperties) {
        ...
        telemetry_1.TelemetryUtils.sendErrorEvent(telemetry_1.TelemetryEventName.appStudioApi, error, Object.assign({ method: (_d = e.request) === null || _d === void 0 ? void 0 : _d.method, "status-code": `${(_e = e === null || e === void 0 ? void 0 : e.response) === null || _e === void 0 ? void 0 : _e.status}`, url: `<${apiName}-url>` }, telemetryProperties));
        return error;
    }
