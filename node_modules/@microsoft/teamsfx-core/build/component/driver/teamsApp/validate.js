...
let ValidateManifestDriver = class ValidateManifestDriver {
    ...
    async validate(args, context) {
        ...
        const manifestRes = await ManifestUtils_1.manifestUtils.getManifestV3(common_1.getAbsolutePath(args.manifestPath, context.projectPath));
        ...
        if (validationResult.length > 0) {
            ...
            lodash_1.merge(context.telemetryProperties, {
                [telemetry_1.TelemetryPropertyKey.validationErrors]: validationResult
                    .map((r) => r.replace(/\//g, ""))
                    .join(";"),
            });
            ...
            if (args.showMessage) {
                (_d = context.ui) === null || _d === void 0 ? void 0 : _d.showMessage("info", validationSuccess, false);
            }
