...
export declare class UnknownResourceAppIdUserError extends UserError {
    constructor(actionName: string, unknownId: string);
}
export declare class UnknownResourceAccessIdUserError extends UserError {
    constructor(actionName: string, unknownId: string);
}
export declare class UnknownResourceAccessTypeUserError extends UserError {
    constructor(actionName: string, unknownType: string);
}
//# sourceMappingURL=aadManifestError.d.ts.map