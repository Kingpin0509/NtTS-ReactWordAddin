        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                if (error.response.status >= 400 && error.response.status < 500) {
                    return {
                        result: teamsfx_api_1.err(new common_1.HttpClientError(actionName, message, helpLink)),
                        summaries: summaries,
                    };
                }
                else {
                    return {
                        result: teamsfx_api_1.err(new common_1.HttpServerError(actionName, message)),
                        summaries: summaries,
                    };
                }
            }
