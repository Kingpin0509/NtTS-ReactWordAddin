        ...
        try {
            ...
            if (axios_1.default.isAxiosError(error)) {
                ...
                if (error.response.status >= 400 && error.response.status < 500) {
                    throw new common_2.HttpClientError(actionName, message, helpLink);
                }
                else {
                    throw new common_2.HttpServerError(actionName, message);
                }
            }
...
tslib_1.__decorate([
    lib_1.hooks([
        ...
        updateProgress_1.updateProgress(localizeUtils_1.getLocalizedString(constants_1.progressBarKeys.creatingBotAadApp)),
    ]),
    tslib_1.__metadata("design:type", Function),
