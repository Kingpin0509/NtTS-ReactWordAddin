...
class CollaborationUtil {
    ...
    static async parseManifestId(appId) {
        var _a;
...
async function listCollaborator(ctx, inputs, tokenProvider, telemetryProps) {
    ...
    const aadCollaboration = new collaboration_1.AadCollaboration(tokenProvider.m365TokenProvider);
    ...
    if (inputs.platform === teamsfx_api_1.Platform.CLI || inputs.platform === teamsfx_api_1.Platform.VSCode) {
        ...
        if (inputs.platform === teamsfx_api_1.Platform.CLI) {
            ...
            ctx.userInteraction.showMessage("info", localizeUtils_1.getLocalizedString("core.collaboration.ListCollaboratorsSuccess", constants_1.VSCodeExtensionCommand.showOutputChannel), false);
