...
const constants_3 = require("./utils/debug/constants");
...
async function manifestsMigration(context) {
    ...
    for (const file of oldAppPackageFiles) {
        if (file !== constants_2.MANIFEST_TEMPLATE_CONSOLIDATE && file !== versionMetadata_1.MetadataV2.aadTemplateFileName) {
