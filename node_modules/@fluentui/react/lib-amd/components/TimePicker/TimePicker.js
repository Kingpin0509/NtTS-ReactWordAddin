define(["require", "exports", "tslib", "react", "../../Utilities", "@fluentui/date-time-utilities", "../../ComboBox", "../../Utilities", "@fluentui/react-hooks"], function (require, exports, tslib_1, React, Utilities_1, date_time_utilities_1, ComboBox_1, Utilities_2, react_hooks_1) {
    ...
    var TimePicker = function (_a) {
        ...
        var fallbackDateAnchor = react_hooks_1.useConst(new Date());
        var _k = react_hooks_1.useControllableValue(value, defaultValue), selectedTime = _k[0], setSelectedTime = _k[1];
        ...
        var timePickerOptions = React.useMemo(function () {
            ...
            return optionsList.map(function (_, index) {
                var option = date_time_utilities_1.addMinutes(dateStartAnchor, increments * index);
                option.setSeconds(0);
                var formattedTimeString = date_time_utilities_1.formatTimeString(option, showSeconds, useHour12);
        ...
        React.useEffect(function () {
            if (selectedTime && !isNaN(selectedTime.valueOf())) {
                var formattedTimeString_1 = date_time_utilities_1.formatTimeString(selectedTime, showSeconds, useHour12);
        ...
        var onInputChange = React.useCallback(function (ev, option, _index, input) {
            var validateUserInput = function (userInput) {
                ...
                if (!regex.test(userInput)) {
                    ...
                    var optionDate = date_time_utilities_1.getDateFromTimeSelection(useHour12, dateStartAnchor, userInput);
                    if (optionDate < dateStartAnchor || optionDate > dateEndAnchor) {
                        errorMessageToDisplay = Utilities_2.format(strings.timeOutOfBoundsErrorMessage, dateStartAnchor.toString(), dateEndAnchor.toString());
                    }
                }
            ...
            if (errorMessageToDisplay || (input !== undefined && !input.length)) {
                ...
                var updatedTime = date_time_utilities_1.getDateFromTimeSelection(useHour12, dateStartAnchor, timeSelection);
    ...
    var getDateAnchor = function (internalDateAnchor, startEnd, increments, timeRange) {
        ...
        return date_time_utilities_1.ceilMinuteToIncrement(clampedDateAnchor, increments);
    };
